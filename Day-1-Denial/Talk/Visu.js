...
const dialogData = [
  {
    text: "Vania menatap Aisyah dengan tajam, jemarinya mengepal. Hatinya masih dipenuhi amarah, tetapi ada sesuatu yang menghentikannya. Entah kenapa, melihat wajah Aisyah yang tetap tenang meski jelas merasa takut, membuatnya merasa… aneh.",
    speaker: "left",
    name: "Narator",
    expression: "Nothing",
  ...
  {
    text: "Ia menarik napas panjang, mencoba menekan emosi yang membara.",
    speaker: "left",
    name: "Narator",
    expression: "Nothing",
    background: "../../asset/BackGroun/bg27.png",
  ...
  {
    text: "Dengerin baik-baik, Aisyah. Aku kasih kamu satu kesempatan. Jangan pernah ikut campur urusan aku lagi",
    speaker: "right",
    name: "Vania",
  ...
  {
    text: "Ayo, kita pergi. Nggak ada gunanya buang-buang waktu di sini",
    speaker: "right",
    name: "Vania",
    expression: "Vania_Marah",
    background: "../../asset/BackGroun/bg27.png",
  ...
  {
    text: "Ia seharusnya lega. Vania tidak benar-benar menyakitinya. Tetapi kata-kata itu… nada ancaman itu… tetap membuat dadanya terasa sesak.",
    speaker: "right",
    name: "Narator",
    expression: "Nothing",
    background: "../../asset/BackGroun/bg27a.png",
    moveBg: false,
    transitionText: "Vania dan teman-temannya pun pergi",
    minigameURL: "",
  },
  {
    text: "Aisyah menghela napas perlahan, menatap ke arah lantai.",
    speaker: "right",
    name: "Narator",
    expression: "Nothing",
    background: "../../asset/BackGroun/bg27a.png",

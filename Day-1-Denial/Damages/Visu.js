...
const dialogData = [
    { 
        text: "Vania menatap Aisyah dengan penuh amarah. Dalam pikirannya, kejadian tadi di kelas terus terngiang. Semua orang mulai membanding-bandingkan dirinya dengan Aisyah—anak baik, anak pintar, anak kesayangan guru.", 
        speaker: "left", 
        name:"Narator",
        expression: "Nothing", 
    ...
    { 
        text: "Hatinya terasa panas. Tanpa berpikir panjang, ia melangkah lebih dekat. Lalu mendorong Aisyah", 
        speaker: "left", 
        name:"Narator",
        expression: "Nothing", 
        background: "../../asset/BackGroun/bg28.png", 
    ...
    { 
        text: "Kalau kamu pintar, kamu seharusnya tahu kapan harus diam", 
        speaker: "right", 
        name:"Vania",
    ...
    { 
        text: "Sekarang dia tahu kalau ikut campur itu nggak ada gunanya.", 
        speaker: "right", 
        name:"Alex",
        ...
        text: "Udah, Van... Kayaknya cukup deh", 
        speaker: "right", 
        name:"Rizki",
        ...
        text: "Dengerin baik-baik, Aisyah. Lain kali, tutup mulutmu. Nggak ada yang suka sama pengadu", 
        speaker: "right", 
        name:"Vania",
        expression: "Vania_Marah", 
        background: "../../asset/BackGroun/bg27a.png", 
        ...
        text: "Hatinya perih, bukan hanya karena dorongan itu, tapi juga karena kenyataan bahwa teman-teman di kelas yang menyaksikan kejadian tadi hanya terdiam. Tidak ada yang membelanya.", 
        speaker: "right", 
        name:"Narator",
        expression: "Nothing", 
        background: "../../asset/BackGroun/bg27.png", 
        moveBg:false, 
        transitionText:"Setelah merasa puas, Vania melangkah pergi, diikuti oleh Alex dan Rizki. Aisyah tetap diam di tempatnya, menunduk." ,
        minigameURL: ""

...
const dialogData = [
    { 
        ...
        name:"Aisyah",
        expression: "Nothing", 
        background: "../../asset/BackGroun/bg42.png", 
        moveBg:true, 
    ...
    { 
        text: "Ini sebagai hukuman karna kamu sudah berani macam2 lagi dan ingat ini tidak akan berakhir", 
        speaker: "left", 
        name:"Vania",
        expression: "Nothing", 
        background: "../../asset/BackGroun/bg42.png", 
    ...
    { 
        text: "Sudah terlambat, semua ini salah kamu sendiri", 
        speaker: "right", 
        name:"Vania",
        expression: "Nothing", 
        background: "../../asset/BackGroun/bg42.png", 
    ...
    { 
        text: "Kekacauan yang dibuat Vania bukan hanya membuat Aisyah sedih tapi juha membuat Aisyah mulai merasa bahwa keberadaannya itu hanya lah sampah dan tidak pantas untuk hidup", 
        speaker: "left", 
        name:"Narator",
        expression: "Nothing", 
        background: "../../asset/BackGroun/bg43.png", 
        moveBg:true, 
        transitionText:"Akhirnya Vania pergi meninggalkan Aisyah yang membereskan kekacauan yang telah di buat Vania" ,
        minigameURL: ""

...
const quizData = [
  ...
  },
  {
    ...
    explanation:
      "Kagum dan Suka, karena Rizki merasa kagum dengan Vania yang selalu berani dan tidak terlalu tertarik dengan nya membvuat Rizki jatuh hati dan mengikuti VaniaKejujuran yang baik adalah kejujuran yang dilakukan dengan penuh tanggung jawab, bukan karena emosi. BK mengajarkan bahwa cara menyampaikan kebenaran sama pentingnya dengan isi kebenaran itu sendiri",
  },
  {
  ...
  },
  {
    ...
    background: "../../asset/BackGroun/bg26.png",
    explanation:
      "Salah satu prinsip konseling adalah menggali akar masalah, bukan langsung menghukum. Anak seperti Vania mungkin bertindak karena masalah di rumah atau emosi yang tak terkendali. Mendengar adalah langkah awal untuk perubahan.",
  },
